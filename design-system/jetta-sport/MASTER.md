...
**Project:** Jetta Sport
**Generated:** 2026-07-25 09:41:56
**Category:** E-commerce Luxury

---

> ⚠️ **NÃO USE A PALETA/TIPOGRAFIA ABAIXO COMO FONTE DA VERDADE.**
> Esta seção foi gerada por uma busca genérica da skill `ui-ux-pro-max` e diverge
> da identidade visual real do projeto. A paleta e tipografia oficiais estão em
> `src/app/globals.css` (`--jetta-black #05070a`, `--jetta-blue #18bfff`,
> `--jetta-cyan #5debff`, `--jetta-gold #dfae42`, `--jetta-wine #8f1733`,
> `--jetta-red #ff315f`) e no `PRD_Jetta_Sport.md` §6 (headings Orbitron,
> corpo **Inter** — não JetBrains Mono). Use as regras de espaçamento,
> componentes e o checklist de pré-entrega abaixo normalmente; apenas ignore
> a tabela de cores e a fonte de corpo nesta seção.
