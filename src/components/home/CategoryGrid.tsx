      ...
      <div className="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
        {categories.map((category) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-jetta-black/90 via-jetta-black/20 to-transparent transition-colors group-hover:from-jetta-black/95 [html[data-theme=light]_&]:opacity-0" />
